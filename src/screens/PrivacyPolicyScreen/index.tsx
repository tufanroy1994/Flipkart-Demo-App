...
import {BaseText, BaseDropdown} from '../../components';
import {AppStrings, AppColors, LanguageList} from '../../utils';
import {useAppNavigation, useAppDispatch, useTranslation} from '../../hooks';
...
const PrivacyPolicyScreen = () => {
  ...
  const googlePolicyLinkPress = () => {
    Linking.openURL('https://policies.google.com/privacy?hl=en');
  };

  const googleGaopoutLinkPress = () => {
    ...
    <ScrollView style={[styles.container]}>
      ...
      <View style={[styles.contentContainer]}>
        ...
        <Text style={styles.text}>
          ...
          and the applicable service/product terms and conditions, and agree to
          be governed by the laws of India including but not limited to the laws
        ...
        <Text style={[styles.text]}>
          ...
          personal data here:{' '}
          <Text style={[styles.link]} onPress={googlePolicyLinkPress}>
            https://www.google.com/intl/en/policies/privacy/
          </Text>
          . You can opt-out of Google Analytics here:{' '}
          <Text style={[styles.link]} onPress={googleGaopoutLinkPress}>
        ...
        <BaseText
          ...
          {AppStrings.sharing_of_personal_data}
        </BaseText>
        <Text></Text>
        <Text style={[styles.text]}>
          We may share personal data internally within Flipkart group companies
          including Flipkart Advanz Private Limited, Scapic Innovations Private
          Limited, and other Flipkart affiliates, related companies and third
          parties, including Credit Bureaus and business partners (such as UPI
          platform), for purposes of providing products and services offered by
          them, such as, personal loans offered by Scapic Innovations Private
          Limited through its lending partners, insurance, the deferred payment
          options, Flipkart PayLater offered by Flipkart Advanz Private Limited
          through its lending partners. These entities and affiliates may share
          such information with their affiliates, business partners and other
          third parties for the purpose of conducting the required checks,
        ...
        <BaseText
          ...
          {AppStrings.links_to_other_sites}
        </BaseText>
        <Text></Text>
        <Text style={[styles.text]}>
          ...
          privacy policies. Flipkart shall not be responsible for the privacy
        ...
        <BaseText
          ...
          {AppStrings.security_precautions}
        </BaseText>
        <Text></Text>
        <Text style={[styles.text]}>
        ...
        <BaseText
          ...
          {AppStrings.advertisements_on_platform}
        </BaseText>
        <Text></Text>
        <Text style={[styles.text]}>
          ...
          settings application. Flipkart will have no access to your GAID once
        ...
        <BaseText
          ...
          {AppStrings.children_information}
        </BaseText>
        <Text></Text>
        <Text style={[styles.text]}>
        ...
        <Text style={[styles.text]}>
          ...
          prevent fraud or future abuse, to enable Flipkart to exercise its
        ...
        <BaseText
          ...
          {AppStrings.changes_to_this_privacy_policy}
        </BaseText>
        <Text></Text>
        <Text style={[styles.text]}>
        ...
        <Text style={[styles.text]}>
          ...
          contact us at privacy.grievance@flipkart.com
        </Text>
        <Text></Text>
        <Text style={[styles.text]}>
          ...
          <Text style={[styles.link]}>https://www.flipkart.com/helpcentre</Text>
        </Text>
        <Text></Text>
