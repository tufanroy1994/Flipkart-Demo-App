...
const TermsScreen = () => {
  const navigation = useAppNavigation('TermsScreen');
  ...
  return (
    <ScrollView style={[styles.container]}>
      <View style={[styles.header]}>
        ...
        />
        <BaseText>{AppStrings.flipkart_com}</BaseText>
      </View>
      <View style={[styles.contentContainer]}>
        <Text style={[styles.mainText]}>
          <Text style={[styles.text]}>{AppStrings.disclaimer}: </Text>
        ...
        <Text style={[styles.mainText, {fontWeight: 'bold'}]}>
          {AppStrings.flipkart_terms_of_use}
        </Text>
        ...
        <Text style={[styles.text]}>
          ...
          \[www.flipkart.com\] (“Website”), including the related mobile site
        ...
        <Text style={[styles.text]}>
          ...
          contracting with Flipkart Internet Private Limited and these terms and
        ...
        <Text style={[styles.text]}>
          ...
          computer systems. Flipkart allows the User to surf the Platform or
          making purchases without registering on the Platform. The term "We",
          "Us", "Our" shall mean Flipkart Internet Private Limited.
        </Text>
        <Text></Text>
        <Text style={[styles.text]}>
          ...
          to be bound by Flipkart Policies ((including but not limited to
          Privacy Policy available at Privacy)) as amended from time to time.
        </Text>
        <Text></Text>
        <Text style={[styles.text]}>{AppStrings.membership_eligibility}</Text>
        <Text></Text>
        <Text style={[styles.text]}>
        ...
        <Text style={[styles.text]}>
          ...
          Flipkart reserves the right to terminate your membership and / or
          refuse to provide you with access to the Platform if it is brought to
          Flipkart's notice or if it is discovered that You are under the age of
          18 years and transacting on the Platform.
        </Text>
        <Text></Text>
        <Text style={[styles.text]}>
          {AppStrings.your_account_and_registration}
        </Text>
        <Text></Text>
        <Text style={[styles.text]}>
        ...
        <Text style={[styles.text]}>
          ...
          Flipkart of any unauthorized use of Your account. If there is reason
          to believe that there is likely to be a breach of security or misuse
          of Your account, We may request You to change the password or we may
          suspend Your account without any liability to Flipkart, for such
          period of time as we deem appropriate in the circumstances. We shall
          not be liable for any loss or damage arising from Your failure to
          comply with this provision.
        </Text>
        <Text></Text>
        <Text style={[styles.text]}>
          You will have access to other apps owned by Flipkart group companies
          through the same login username and password. You agree to have single
          login access to all the apps owned by Flipkart group companies.
        </Text>
        <Text></Text>
        <Text style={[styles.text]}>{AppStrings.communications}</Text>
        <Text></Text>
        <Text style={[styles.text]}>
